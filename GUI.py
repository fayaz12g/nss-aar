...
console_label3= customtkinter.CTkLabel(master=notebook.tab("Generate"), text=f'Aspect Ratio: (Auto-Deteced as {screen_width} x {screen_height}):')

frame = customtkinter.CTkFrame(master=notebook.tab("Generate"))
